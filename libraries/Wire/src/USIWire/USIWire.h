...
#if defined(USIDR) //USI hardware

#include <stddef.h>
#include <inttypes.h>

// Buffer sizes are defined in USI_TWI_Slave.h
...
// For compatibility with libraries that requires a TwoWire object
typedef USIWire TwoWire;
